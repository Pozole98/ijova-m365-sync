 ...
 * Lógica interactiva para verificación, confirmación y reseteo de contraseñas.
 */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Elementos de la Ficha de Alumno
  ...
  // Elementos de Confirmación y Reseteo
  ...
  // Elementos del Ticket Imprimible
  ...
  // Disparar búsqueda al presionar ENTER o botón
  ...
  // ==========================================
  // FUNCIÓN CENTRAL: VERIFICAR ALUMNO
  // ==========================================
  ...
  confirmCheckbox.addEventListener('change', () => {
    ...
    if (confirmCheckbox.checked) {
      btnExecuteReset.classList.add('pulse-ready');
    } else {
      btnExecuteReset.classList.remove('pulse-ready');
    }
  });
  ...
  btnExecuteReset.addEventListener('click', async () => {
    ...
    if (pwModeCustom.checked) {
      ...
      if (!customPw) {
        alert('Por favor ingresa la contraseña personalizada o selecciona la opción de generación aleatoria.');
        inputCustomPassword.focus();
        return;
      }
    }
    ...
    try {
      ...
      // Éxito: Ocultar verificación y mostrar pantalla de éxito
      verificationCard.style.display = 'none';
      ...
      // Actualizar datos del ticket imprimible
      ...
      // Configurar enlaces de PDF
      if (result.pdf_url) {
        btnPrintVoucher.href = result.pdf_url;
        btnPrintVoucher.onclick = (e) => {
          e.preventDefault();
          // Abrir PDF en ventana nueva para imprimir directamente
        ...
        // Fallback: imprimir elemento HTML
        btnPrintVoucher.onclick = (e) => {
          e.preventDefault();
          window.print();
        };
